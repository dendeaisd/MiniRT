...
/*   Updated: 2024/06/26 20:08:48 by mevangel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
					...
					t_vec hit_point, t_vec normal)
{
	...
	shadow_factor = 1.0f - (cast_shadow(scene, hit_point, \
				scene->light, normal) * 0.3);
	shadow_factor *= 1.0f - cast_object_soft_shadows(scene, hit_object, \
				hit_point, &scene->light);
